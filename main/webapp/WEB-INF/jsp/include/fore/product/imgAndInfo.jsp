...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="/img/product/type_single/${p.firstProductImage.id}.jpg" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${p.productSingleImages}" var="pi">
                <img src="/img/product/productSingle_small/${pi.id}.jpg" bigImageURL="/img/product/type_single/${pi.id}.jpg" class="smallImage">
            </c:forEach>
        </div>
