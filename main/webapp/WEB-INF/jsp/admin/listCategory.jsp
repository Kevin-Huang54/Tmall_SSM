...
<div class="workingArea">
    <h1 style="font-size: large" class="label label-info">分类管理</h1>
    <br>
    <br>
        ...
        <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <c:forEach items="${cs}" var="category">
                <tr>
                    ...
                    <td><a href="admin_category_edit?cid=${category.id}"><span class="glyphicon glyphicon-edit"></span></a> </td>
                    <td><a deletelink="true" href="admin_category_delete?cid=${category.id}"><span class="glyphicon glyphicon-trash"></span></a> </td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
